package kr.co.hs.view.hspatternlockview;
...
/**
 * https://github.com/hsbaewa/MaterialPatternllockView
 */
public class HsPatternLockView extends View {
    ...
    public HsPatternLockView(Context context) {
        this(context, null);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public HsPatternLockView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs,R.styleable.HsPatternLockView);
        mRegularColor = typedArray.getColor(R.styleable.HsPatternLockView_LOCK_COLOR, Color.WHITE);
        mErrorColor = typedArray.getColor(R.styleable.HsPatternLockView_WRONG_COLOR, Color.RED);
        mSuccessColor = typedArray.getColor(R.styleable.HsPatternLockView_CORRECT_COLOR, Color.GREEN);
        typedArray.recycle();
    ...
    void startLineEndAnimation(final CellState state,
    ...
    private static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link HsPatternLockView#onSaveInstanceState()}
         */
